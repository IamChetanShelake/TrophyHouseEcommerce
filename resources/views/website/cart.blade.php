                                ...
                                @php
                                    ...
                                    if ($cart->customizationRequest ?? false) {
                                        if ($cart->quantity >= 1 && $cart->quantity <= 9) {
                                            $printingCharge = 50 * $cart->quantity;
                                        } elseif ($cart->quantity >= 10 && $cart->quantity <= 24) {
                                            $printingCharge = 35 * $cart->quantity;
                                        } else {
                                            $printingCharge = 25 * $cart->quantity;
                                        }
                                    }
                                    $totalWithPrinting = $cart->variant->price * $cart->quantity + $printingCharge;
                                @endphp
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <b>
                                                        <center> you have customization remaning for your other cart trophy,
                                                            would you like to personalize them with photos and text?
                                                        </center>
                                                    </b>
                                                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="order-summary">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span id="shipping-charges" class="">
                                    ₹ 00.00
                                </span>
                            </div>
                            <div class="d-flex justify-content-between ">
