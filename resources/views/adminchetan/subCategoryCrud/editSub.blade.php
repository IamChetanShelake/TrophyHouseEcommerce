            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('subCategory.update', $subcat->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label for="name">title</label>
                                <input type="text" class="form-control" id="name" name="subcat_name"
                                    value="{{ $subcat->title }}" placeholder="" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="subcat_desc" class="form-control" id="subcat_desc" rows="4">{{ $subcat->description }}</textarea>
                            </div>

                                <div class="">
                                <img src="{{asset('sub-category_images/'.$subcat->image)}}" alt="" width="70px;">
                                </div>
