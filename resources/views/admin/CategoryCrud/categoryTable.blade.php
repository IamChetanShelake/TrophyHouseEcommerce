    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <a href="{{ route('category.add') }}" class="btn btn-gradient-primary me-2">Add Category</a>
            </nav>
        </div>
        <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($cats as $cat)
                                    <tr>
                                        ...
                                        @if ($cat->image)
                                            <td><img src="{{ asset('category_images/' . $cat->image) }}" alt=""></td>
                                        @else
                                            <td>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ route('category.show', $cat->id) }}" class="btn btn-info">View</a>
                                        </td>
                                        <td>
