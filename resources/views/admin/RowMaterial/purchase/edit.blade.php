    ...
    <div class="content-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p style="font-family: Rubik; font-size: 38px; font-weight: 500; color: #000;">Edit Purchase</p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-lg-12">
                         <div class="card">
                            <div class="card-body">
                        <form id="purchaseForm" method="POST" action="{{ route('admin.purchase.update', $purchase->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <!-- Material -->
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="quantity" id="quantity" class="form-control"
                                        value="{{ old('quantity', $purchase->quantity) }}" step="0.01" min="0"
                                        required>
                                    @error('quantity')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="total_cost" id="total_cost" class="form-control"
                                        value="{{ old('total_cost', $purchase->total_cost) }}" step="0.01" min="0"
                                        required>
                                    @error('total_cost')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
