            ...
            <div class="container-xl">
                ...
                <div class="row" style="display: flex; justify-content: space-between;">
                    <div class="col-lg-11 col-sm-10">
                        <p style="font-family: Rubik; font-size: 38px; font-weight: 500; color: #000;">Purchases</p>
                    </div>
                    <div class="col-lg-1 col-sm-2">
                        <a href="{{ route('admin.purchase.create') }}" class="btn btn-primary" style="font-size: 18px;">
                            Add New
                        </a>
                    </div>
                </div>
