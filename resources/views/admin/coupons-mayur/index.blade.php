    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <a href="{{ route('client.add') }}" class="btn btn-gradient-primary me-2">Add Coupon Code</a>
            </nav>
        </div>
        <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($coupons as $cp)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('coupons.view', $cp->id) }}" class="btn btn-info">View</a>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-1" style="justify-content: center;">

                                                <a href="{{ route('coupons.edit', $cp->id) }}"
                                                    class="btn btn-success">Update</a>
                                                <form action="{{ route('coupons.destroy', $cp->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
