    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <a href="{{ route('gallery.add') }}" class="btn btn-gradient-primary me-2">Add Gallery</a>
            </nav>
        </div>
        <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($gallery as $gal)
                                    <tr>
                                        ...
                                        @if ($gal->image)
                                            <td><img src="{{ asset('gallery_images/' . $gal->image) }}" alt=""></td>
                                        @else
                                            <td>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ route('gallery.view', $gal->id) }}" class="btn btn-info">View</a>
                                        </td>
                                        <td>
