...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p style="font-family: Rubik; font-size: 38px; font-weight: 500; color: #000;">Edit Supplier</p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-lg-12">
                                ...
                                <form id="supplierForm" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" name="purchase_date" id="purchase_date"
                                                class="form-control"
                                                value="{{ old('purchase_date', $supplier->purchase_date) }}" required>
                                            @error('purchase_date')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="bill_no" id="bill_no" class="form-control"
                                                value="{{ old('bill_no', $supplier->bill_no) }}" required>
                                            @error('bill_no')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                                    ...
                                                    <tr class="material-row">
                                                            ...
                                                            <select name="material_type_id[]"
                                                                ...
                                                                @foreach ($materialTypes as $type)
                                                                    <option value="{{ $type->id }}"
                                                                        {{ $type->id == $purchase->material->category_id ? 'selected' : '' }}>
                                                                        {{ $type->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <select name="material_id[]"
                                                                ...
                                                                @foreach ($materials as $material)
                                                                    @if ($material->category_id == $purchase->material->category_id)
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control current-stock"
                                                                value="{{ $purchase->material->current_stock }}" readonly>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="unit_price[]"
                                                                class="form-control unit-price"
                                                                value="{{ $purchase->unit_price }}" step="0.01"
                                                                min="0" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="quantity[]"
                                                                class="form-control quantity"
                                                                value="{{ $purchase->quantity }}" step="0.01"
                                                                min="0" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="total_cost[]"
                                                                class="form-control total-cost"
                                                                value="{{ $purchase->total_cost }}" readonly>
                                                        </td>
                                                        <td>
                                                            <button type="button"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12 text-center">
                                            <button type="button" id="add-row" class="btn btn-add-row">Add
                                                Row</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initial sub amount calculation
            updateSubAmount();
        });
    </script>
@endsection
