                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p style="font-family: Rubik; font-size: 38px; font-weight: 500; color: #000;"><a
                                href="{{ route('admin.purchase.index', $purchase->material->id) }}"><i
                                    class='fa fa-arrow-circle-left' style='font-size:36px;color:green;'></i></a>Edit
                            Purchase({{ $purchase->material->name }})</p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-lg-12">
                                    ...
                                    @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" id="material_name" class="form-control"
                                                value="{{ $purchase->material->name }}" readonly>

                                            <input type="hidden" name="material_id" value="{{ $purchase->material_id }}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" name="quantity" id="quantity" class="form-control"
                                                value="{{ old('quantity', $purchase->quantity) }}" step="0.01"
                                                min="0" required>
                                            @error('quantity')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" name="unit_price" id="unit_price" class="form-control"
                                                value="{{ old('unit_price', $purchase->unit_price) }}" step="0.01"
                                                min="0" required>
                                            @error('unit_price')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" name="total_cost" id="total_cost" class="form-control"
                                                value="{{ old('total_cost', $purchase->total_cost) }}" step="0.01"
                                                min="0" required>
                                            @error('total_cost')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="supplier_contact" class="form-label">Supplier Contact</label>
                                            <input type="number" name="supplier_contact" id="supplier_contact"
                                                class="form-control"
                                                value="{{ old('supplier_contact', $purchase->supplier_contact) }}"
