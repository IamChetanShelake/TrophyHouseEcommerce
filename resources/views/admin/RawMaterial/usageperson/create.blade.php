...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p style="font-family: Rubik; font-size: 38px; font-weight: 500; color: #000;">Add Usage Person</p>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="usageForm" method="POST" action="{{ route('admin.usage-person.store') }}">
                                    @csrf
                                    <div class="row">
                                        <!-- Date -->
                                        ...
                                        <table class="table" id="materialTable">
                                            ...
                                            <tbody>
                                                <tr class="material-row">
                                                    <td>
                                                        <select name="material_type_id[]" class="form-control material-type-select" required>
                                                    ...
                                                    <td>
                                                        <input type="number" name="quantity[]" class="form-control quantity" step="0.01" min="0" required>
                                                    </td>
                                                    <td>
                                                        <input type="date" name="usage_date[]" class="form-control usage-date" required>
                                                    </td>
                                                    <td>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            firstRow.querySelector('.material-type-select').addEventListener('change', function () {
            ...
            document.getElementById('add-row').addEventListener('click', function () {
                ...
                newRow.querySelector('.material-select').innerHTML = '<option value="" disabled selected>Select Material</option>';
